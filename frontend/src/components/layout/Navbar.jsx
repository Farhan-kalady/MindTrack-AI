...
import { Brain, LogOut, Bell, PenSquare } from 'lucide-react';
        ...
        <>
            ...
            {showLogoutModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center">
                    ...
                    {/* Modal Card */}
                    <div className="relative bg-white rounded-[16px] p-6 w-full max-w-[380px] shadow-2xl mx-4">
                        <h2 className="text-xl font-bold text-gray-900 mb-2">Sign out of MindTrack AI?</h2>
                        ...
                        <div className="flex justify-end gap-3">
                            ...
                            <button 
                                ...
                                className="px-4 py-2 text-sm font-medium text-white bg-[#EF4444] hover:bg-red-600 rounded-lg transition-colors"
                            >
                                Sign Out
                            </button>
                        </div>
